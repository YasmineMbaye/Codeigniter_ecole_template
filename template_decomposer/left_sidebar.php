                    ...
                    <ul>
                        <li class="menu-title">
                            ...
                            <li class="submenu active">
                                <a href="#"><i class="fa fa-atgit"></i> <span> Test</span> <span
                                        class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="students.html">TEST</a></li>
                                <li><a href="student-details.html">Agents test</a></li>
                                <li><a href="add-student.html">Agents Test</a></li>
                                <li><a href="edit-student.html">Agents Test</a></li>
                            </ul>       
                        </li>
                        <li class="submenu active">
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fas fa-graduation-cap"></i> <span> Agents</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="students.html">Agents List</a></li>
                                <li><a href="student-details.html">Agents View</a></li>
                                <li><a href="add-student.html">Agents Add</a></li>
                                <li><a href="edit-student.html">Agents Edit</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
